...
export default class Analysis {
  ...
  //TODO factorize with _getQualifiedIdentifier
  _getUnqualifiedIdentifier( nodes, i ) {
    let node = nodes[i]
    switch( node.type ) {
      case 'FunctionDeclaration':
        if( ! node.identifier ) {
    ...
    for( let node of nodes ) {
      switch( node.type ) {
        ...
        case 'FunctionDeclaration':
          ...
          this._setDescription( this._getQualifiedIdentifier(nodes, i), Analysis.lastComment )
          this._setDescription( this._getUnqualifiedIdentifier(nodes, i), Analysis.lastComment )
